...
#include "../controller/Base/imageview.h"
...
static const char qt_meta_stringdata_ImageView[] = {
    "ImageView\0\0slotReplyPixmapLoad(QNetworkReply*)\0"
};
...
void ImageView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slotReplyPixmapLoad((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
