...
public:
    ...
    void retranslateUi(QDialog *TableViewDialog)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(userEventTab), QApplication::translate("TableViewDialog", "Swiping card records", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(sessionTab), QApplication::translate("TableViewDialog", "Using records", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(systemEventTab), QApplication::translate("TableViewDialog", "System records ", 0, QApplication::UnicodeUTF8));
        prevButton->setText(QApplication::translate("TableViewDialog", "Back", 0, QApplication::UnicodeUTF8));
        pageLabel->setText(QApplication::translate("TableViewDialog", "0/0", 0, QApplication::UnicodeUTF8));
        nextButton->setText(QApplication::translate("TableViewDialog", "Next", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        closeButton->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        closeButton->setText(QApplication::translate("TableViewDialog", "Close", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
