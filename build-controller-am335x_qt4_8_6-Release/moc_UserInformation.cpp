...
const QMetaObjectExtraData UserInformation::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UserInformation::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UserInformation,
      qt_meta_data_UserInformation, &staticMetaObjectExtraData }
};
